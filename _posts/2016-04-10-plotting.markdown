...
Distribution must be saved as *data.txt*.
After executing the command, the following image will be generated in local dir (*scoreDist.png*):

<div align="center">
    <img src="/assets/2016-04-10-plotting/scoreDist.png" width="560"/>
</div>

Each bar indicates the number of students (occurrences) with the respective score.
...
<br/>
Data visualization allied with statistical analysis ... a lot of applications.
